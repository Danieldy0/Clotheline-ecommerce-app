    ...
    <>
      ...
      <div className="fixed top-0 left-0 h-full w-64 bg-white dark:bg-black shadow-xl transform -translate-x-full peer-checked:translate-x-0 transition-transform duration-300 z-[60] p-6 md:hidden">
        <div className="flex items-center justify-between mb-6">
          ...
          <label htmlFor="menu_toggle" className="cursor-pointer p-1 rounded hover:bg-gray-100 dark:hover:bg-gray-800" aria-label="Close menu">
      ...
      >
        <div className="flex items-center gap-6">
          <h1 className="text-2xl font-bold tracking-wide text-black dark:text-white">Clothline.</h1>
        ...
        <div className="hidden md:flex items-center">
          <ul className="flex items-center gap-10 font-medium text-black dark:text-white">
        ...
        <div className="hidden md:flex gap-4 items-center">
          ...
          <div className="flex items-center gap-3">
            {darkMode ? <SunIcon className="w-5 h-5 text-white dark:text-white" /> : <MoonIcon className="w-5 h-5 text-black dark:text-black" />}
            <Switch
              checked={darkMode}
              onChange={setDarkMode}
              className={`${darkMode ? "bg-white" : "bg-gray-400"} relative inline-flex h-6 w-11 items-center rounded-full transition`}
            >
              <span className={`${darkMode ? "translate-x-6 bg-black" : "translate-x-1 bg-white dark:bg-black"} inline-block h-4 w-4 transform rounded-full transition`} />
            </Switch>
          </div>
        ...
        <div className="flex md:hidden gap-4 items-center">
          <div className="flex items-center gap-3">
            {darkMode ? <SunIcon className="w-5 h-5 text-white dark:text-white" /> : <MoonIcon className="w-5 h-5 text-black dark:text-white" />}
            <Switch
              checked={darkMode}
              onChange={setDarkMode}
              className={`${darkMode ? "bg-white" : "bg-gray-400"} relative inline-flex h-6 w-11 items-center rounded-full transition`}
